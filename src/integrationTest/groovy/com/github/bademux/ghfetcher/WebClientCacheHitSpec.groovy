...
@Stepwise
class WebClientCacheHitSpec extends Specification {
    ...
    final static WireMockClassRule wireMock = new WireMockClassRule(wireMockConfig()
            ...
            .withRootDirectory("src/integrationTest/resources/${WebClientCacheHitSpec.simpleName}")
            .dynamicPort())
    ...
    Should 'use cache on 2nd request'() {
        when:
